  ...
  return (
    <div
      className={`w-full rounded-lg border p-4 text-left transition-colors ${
        selected ? 'border-forensic-gold/50 bg-forensic-gold/10' : 'border-graphite-800 bg-graphite-900 hover:border-forensic-gold/30'
      }`}
    >
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
        <Link
          ...
          className="inline-flex items-center justify-center gap-1 rounded border border-graphite-800 px-2 py-2 text-xs text-forensic-stone"
        >
        ...
        <Link to={`/report?sampleId=${sample.id}`} className="inline-flex items-center justify-center gap-1 rounded border border-graphite-800 px-2 py-2 text-xs text-forensic-stone">
