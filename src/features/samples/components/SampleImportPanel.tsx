...
export function SampleImportPanel({ onImport, imported }: SampleImportPanelProps) {
  return (
    <div className="grid grid-cols-[1fr_280px] gap-4">
      <div className="rounded-md border border-dashed border-graphite-800 bg-black/20 p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <div className="rounded-md border border-graphite-800 bg-graphite-850 p-3">
      ...
      <div className="rounded-md border border-graphite-800 bg-graphite-850 p-5">
